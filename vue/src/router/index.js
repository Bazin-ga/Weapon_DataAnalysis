...
export const constantRoutes = [
...

  {
    ...
    children: [{
      ...
      meta: { title: '数据信息', icon: 'dashboard' }
    }]
  },

  {
    ...
    redirect: '/friends',
    name: 'Friends',
    meta: { title: 'lds代码调试', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'tset2',
        name: 'test2',
        component: () => import('@/views/friends/test2/index'),
        meta: { title: '展示的', icon: 'table ' }
      },
      {
        path: 'tset',
        name: 'test',
        component: () => import('@/views/friends/test/index'),
        meta: { title: '原版的', icon: 'table ' }
      },
      {
        path: 'tset3',
        name: 'test3',
        component: () => import('@/views/friends/test3/index1_20备份'),
        meta: { title: '1月20日版本', icon: 'table ' }
      },
      {
        path: 'tset4',
        name: 'test4',
        component: () => import('@/views/friends/test4/enchart画图'),
        meta: { title: 'enchart', icon: 'table ' }
      }
    ]
  },
...

  {
    ...
    redirect: '/user',
    name: 'Data',
    meta: { title: '用户功能', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'user',
        name: 'user',
...

  {
    ...
    redirect: '/merchant',
    name: 'merchant',
    meta: { title: '商家功能', icon: 'el-icon-s-help' },
    children: [
      {
        path: 'merchant',
        name: 'merchant',
